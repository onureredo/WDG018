...
age = 26; // age kann neu zugewiesen werden, weil es mit let deklariert wurde.

// Reassign the value of name to "Jane Doe".
name = 'Jane Doe'; // name kann neu zugewiesen werden, weil es mit let deklariert wurde.
...
// birthYear und isStudent können nicht neu zugewiesen werden, weil sie mit const deklariert wurden. Ein Fehler wird ausgegeben, wenn man versucht, ihre Werte zu ändern.

// 3- Use console.log to print the values of age, birthYear, name, and isStudent.
...
console.log('Neue Lieblingsfarbe:', favoriteColor);
